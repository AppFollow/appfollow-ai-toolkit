...
Semantic-first when `reviews_semantic` is available; otherwise **client-side classification of
`get_reviews` text is the default fallback** (most plans lack semantic).
